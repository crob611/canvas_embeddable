...
export const EMBEDDABLE_TYPE_ONE = 'ONE';

export class EmbeddableOneEmbeddable extends Embeddable {
  ...
  public render(node: HTMLElement) {
    node.innerHTML = '<div data-test-subj="helloWorldEmbeddable">EMBEDDABLE ONE</div>';
  }
