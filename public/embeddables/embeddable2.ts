...
export const EMBEDDABLE_TYPE_TWO = 'TWO';

export class EmbeddableTwoEmbeddable extends Embeddable {
  ...
  public render(node: HTMLElement) {
    node.innerHTML = '<div data-test-subj="helloWorldEmbeddable">EMBEDDABLE TWO</div>';
  }
